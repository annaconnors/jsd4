...
function rollDice() { 
 	var diceOne = getRandomInt(1,7);
 	var diceTwo = getRandomInt(1,7);
 	var diceNameone = 'dice-' + diceOne;
 	var diceNametwo = 'dice-' + diceTwo; 
 	firstDie.className = diceNameone;
 	secondDie.className = diceNametwo;
